...
<head>
    ...
    <title>Control Panel Anda</title>
    <style>
...
<body>
    ...
    <div class="message success">
        <p>Selamat datang di Control Panel Anda! Silakan login untuk memulai.</p>
    </div>

    <h2>Login ke Control Panel</h2>
    <p>Halaman ini adalah pintu masuk ke sistem administrasi Anda.</p>
    <p><a href="login.php" class="btn">Login Sekarang</a></p>
